...
public class CameraStreamHelper : MonoBehaviour
{
    ...
    public static CameraStreamHelper Instance
    {
        get
        {
            if (instance == null)
            {
                instance = new CameraStreamHelper();
                VideoCapture.CreateAync(instance.OnVideoCaptureInstanceCreated);
            }
            return instance;
        }
    }
    ...
    public void GetVideoCaptureAsync(OnVideoCaptureResourceCreatedCallback onVideoCaptureAvailable)
    {
        ...
        {
            LoggingManager.LogError("You must supply the onVideoCaptureAvailable delegate.");
        }
    ...
    private void OnVideoCaptureInstanceCreated(VideoCapture videoCapture)
    {
        if (videoCapture == null)
        {
            LoggingManager.LogError("Creating the VideoCapture object failed.");
            return;
        }
